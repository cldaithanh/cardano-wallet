...
data FailureToVerifySelectionInputCountWithinLimit = FailureToVerifySelectionInputCountWithinLimit
...
data SelectionOutputCoinInsufficientError address = SelectionOutputCoinInsufficientError
...
data FailureToVerifyInsufficientMinCoinValueError address = FailureToVerifyInsufficientMinCoinValueError
...
data FailureToVerifySelectionLimitReachedError u = FailureToVerifySelectionLimitReachedError
