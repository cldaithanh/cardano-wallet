...
instance (Monad m, DelegationAddress n ShelleyKey)
    => MaybeLight m (SeqState n ShelleyKey)
  where
    maybeDiscover = Just discoverSeqWithRewards
